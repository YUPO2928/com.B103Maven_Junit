...
public class P35_TakeScreenShot extends TestBase {
    ...
    public void name() throws IOException, InterruptedException {
        ...
        String amazonSayfası = driver.getWindowHandle();
        //Tüm sayfanın resmini alalım
        ...
        //Tekrar amazon sayfasına dönüp iphone aratalım.
        driver.switchTo().window(amazonSayfası);
        driver.findElement(By.id("twotabsearchtextbox")).sendKeys("iphone"+ Keys.ENTER);

        //Arama sonucunun resmini alalım. (sadece web element screenshot almak)
