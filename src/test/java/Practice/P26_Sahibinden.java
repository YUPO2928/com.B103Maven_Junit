...
public class P26_Sahibinden extends TestBase {
    ...
    public void test01(){
        ...
        filtre("Ankara","Yenimahalle", "Emniyet Mah.", "500000", "1000000", "TL", "100", "150");
    ...
    public void filtre (String il, String ilce, String Mah, String minFiyat, String maxFiyat, String paraTuru, String MinMetreKare, String MaxMetreKare){
        ...
        ilElement.sendKeys(il);
        driver.findElement(By.xpath("(//*[@class='noChild single-selection'])[1]")).click();
